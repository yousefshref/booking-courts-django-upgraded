...
class ManagerProfile(models.Model):
  ...
  trainer_limit = models.IntegerField(default=0, null=True, blank=True)
  academy_limit = models.IntegerField(default=0, null=True, blank=True)
  courts_limit = models.IntegerField(default=0, null=True, blank=True)
